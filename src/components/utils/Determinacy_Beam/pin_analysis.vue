<template>
  <div class="col-lg-4 text-center">
    ...
    <ul>
      <li>Reactive forces/moments: {{ 8 - currentSelection }}</li>
      <li>
        Equations of Equilibrium: 3
      </li>
      <li>Status: Statically <span v-if="currentSelection === 4">indeterminate</span> <span v-if="currentSelection === 5">determinate</span></li>
    </ul>
  </div>
</template>
<script>
