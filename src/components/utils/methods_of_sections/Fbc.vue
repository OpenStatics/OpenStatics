...
export default {
  ...
  mounted() {
    ...
    */
    ...
    const c = b2.create("point", [1 * scale, 2 * scale], { name: "c", fixed: true, visible: false, fillColor: "blue", strokeColor: "blue" });
    ...
    const g = b2.create("point", [-1 * scale, 0], { name: "g", fixed: true, fillColor: "red", strokeColor: "red" });
    ...
    */
    ...
    b2.create("line", [bc, Fbc], { straightFirst: false, straightLast: false, touchFirstPoint: true, lastArrow: true, strokeColor: "red" });
    b2.create("line", [gf, Fgf], { straightFirst: false, straightLast: false, touchFirstPoint: true, lastArrow: true });
    ...
    const label1 = b2.create("text", [
      ...
      -6,
      () => {
        return "\\Sigma M_G = 0 = F_{BC}*L_{BG} - F*L_{AG}*sin(\\alpha)";
      }
    ]);
