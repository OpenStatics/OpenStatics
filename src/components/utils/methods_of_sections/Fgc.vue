...
export default {
  ...
  mounted() {
    ...
    */
    ...
    b2.create("line", [gc, Fgc], { straightFirst: false, straightLast: false, touchFirstPoint: true, lastArrow: true, strokeColor: "red" });
    ...
    const label1 = b2.create("text", [
      ...
      -6,
      () => {
        return "\\Sigma F_C = 0 = F_{GC}*sin(45^o) - F*sin(\\alpha)";
      }
    ]);
