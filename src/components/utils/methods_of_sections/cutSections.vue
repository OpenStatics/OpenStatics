...
export default {
  ...
  mounted() {
    ...
    */
    ...
    const c = b2.create("point", [1 * scale, 2 * scale], { name: "C", fixed: true, visible: true, fillColor: "blue", strokeColor: "blue" });
    //const d = b2.create("point", [3 * scale, 2 * scale], { name: "d", fixed: true });
    //const e = b2.create("point", [3 * scale, 0], { name: "e", fixed: true });
    const f = b2.create("point", [1 * scale, 0], { name: "F", fixed: true, visible: true, fillColor: "blue", strokeColor: "blue" });
